...
<Steps>
  ...
  <Step title="Add a Vault migration configuration">
    ...
    ![Choose provider](/images/platform/external-migrations/vault-in-platform/select-migration-provider.png)

    Configure the Vault namespace entry:

    ![Namespace configuration modal](/images/platform/external-migrations/vault-in-platform/namespace-configuration-modal.png)
